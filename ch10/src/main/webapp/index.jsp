	...
	<head>
		...
		<!-- 
			...
			배포
			 ...
			 - C:\Users/GGG\apache-tomcat-10.1.43\webapps 폴더에 배포파일(ch10.jar) 업로드 후 Deploy 확인 후 브라우저 확인
		 -->
	</head>
	<body>
		<h3>프로젝트 로그와 배포</h3>	
		...
		<h4>Library</h4>
		<a href="/ch10/college/member/list.do">Member CRUD</a>
		<a href="/ch10/college/book/list.do">Book CRUD</a>
