...
<html>
		...
		document.addEventListener('DOMContentLoaded',function(){
			...
			*/
			document.addEventListener('click', function(e){
				...
				if(e.target.classList == 'index'){
					location.href = "/ch09";
				}
				
				if(e.target.classList == 'register'){
					location.href = "/ch09/js/user1/register.do";
				}
	...
	<body>
		...
		<a href="/ch09" class="index">처음으로</a>
		<a href="/ch09/js/user1/register.do" class="register">등록하기</a>
