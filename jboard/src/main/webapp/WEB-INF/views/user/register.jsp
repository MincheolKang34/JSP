			...
			<table border="1">
				...
				<tr>
					...
					<td><input type="email" name="email" placeholder="이메일 입력" />
						...
						</button> <span class="emailResult"></span>
						<div class="auth">
				...
				<tr>
					<td>주소</td>
					<td><input type="text" id="zip" readonly name="zip" placeholder="우편번호" />
						<button type="button" onclick="postcode()">
							<img src="../images/chk_post.gif" alt="우편번호찾기" />
						</button> <input type="text" id="addr1" name="addr1" readonly placeholder="주소 검색" /> <input
						type="text" id="addr2" name="addr2" placeholder="상세주소 입력" /></td>
				</tr>
			</table>

			<div>
				<a href="/jboard/user/login.do" class="btn btnCancel">취소</a> <input
