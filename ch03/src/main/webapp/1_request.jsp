...
<html>
	<head>
		...
		<%--
			...
			GET 요청
			 - 기본 데이터 요청 방식, 데이터를 쿼리스트림으로 전송(URL주소에 붙여 전송)
	...
	<body>
		...
		<form action="./proc/result2.jsp" method="post">
			<table border="1">
				...
				<tr>
					<td>생년월일</td>
					<td><input type="date" name="birth" placeholder="생년월일 선택하세요."/></td>
				</tr>
				<tr>
		...
		<p>
			...
			헤더 정보 #2 : <%= request.getHeader("referer") %><br/> <!-- 현재 머무르고 있는 페이지 직전의 요청 페이지(이전 페이지) -->
